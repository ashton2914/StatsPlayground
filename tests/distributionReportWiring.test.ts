...
assert.match(presentationSource, /const externalDataState = mapDistributionExternalDataState\(reportState, role\)/);
assert.match(presentationSource, /filterDistributionFitCurvePackets\(/);
