...
assert.doesNotMatch(viewSource, /FitModelSaveColumnsDialog/);
assert.doesNotMatch(viewSource, /fitModelService\.saveColumns\(/);
assert.doesNotMatch(viewSource, /onSaveColumns=/);
